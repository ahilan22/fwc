...
//Set GPIO direction
  ...
  sevenseg(0,0,1,0,0,1,0);//The number 2
  HAL_DelayUSec(1000000);
  sevenseg(0,0,0,0,1,1,0);//The number 3
  HAL_DelayUSec(1000000);
  sevenseg(1,0,0,1,1,0,0);//The number 4
  HAL_DelayUSec(1000000);
  sevenseg(0,1,0,0,1,0,0);//The number 5
  HAL_DelayUSec(1000000);
  sevenseg(1,1,0,0,0,0,0);//The number 6
  HAL_DelayUSec(1000000);
  sevenseg(0,0,0,1,1,1,1);//The number 7
  HAL_DelayUSec(1000000);
  sevenseg(0,0,0,0,0,0,0);//The number 8
  HAL_DelayUSec(1000000);
  sevenseg(0,0,0,1,1,0,0);//The number 9
  HAL_DelayUSec(1000000);
  sevenseg(0,0,0,0,0,0,1);//The number 9
  HAL_DelayUSec(1000000);
  }   
